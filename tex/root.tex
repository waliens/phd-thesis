...
\newacronym{clf}{CLF}{classification}
\newacronym{cnn}{CNN}{convolutional neural network}
\newacronym{cnt}{CNT}{counting}
\newacronym{coco}{COCO}{Common Objects in COntext}
\newacronym{cpath}{CPATH}{computational pathology}
\newacronym{cpu}{CPU}{central processing unit}
\newacronym{ct}{CT}{computed tomography}
\newacronym{crf}{CRF}{conditional random field}
\newacronym{cv}{CV}{cross-validation}
\newacronym{det}{DET}{detection}
...
\newacronym{glas}{GlaS}{Gland Segmentation challenge}
...
\newacronym{lis}{LIS}{laboratory information systems}
\newacronym{loto}{LOTO}{leave-one-task-out}
\newacronym{ml}{ML}{machine learning}
\newacronym{mlp}{MLP}{multi-layer perceptron}
\newacronym{monuseg}{MoNuSeg}{multi-organ nuclei segmentation challenge}
...
\newacronym{reg}{REG}{regression}
\newacronym{relu}{ReLU}{rectified linear unit}
\newacronym{rfe}{RFE}{recursive feature elimination}
\newacronym{roc}{ROC}{receiver operating characteristic}
\newacronym{roi}{ROI}{region of interest}
\newacronym{seg}{SEG}{segmentation}
\newacronym{segpc}{SegPC-2021}{segmentation of multiple myeloma plasma cells in microscopic images}
...
\newacronym{tmn}{TMN}{classification of malignant tumor}
\newacronym{tpr}{TPR}{true positive rate}
\newacronym{ulb}{ULB}{Université Libre de Bruxelles}
...
\newcommand{\bracketed}[1]{\bibopenbracket#1\bibclosebracket}
