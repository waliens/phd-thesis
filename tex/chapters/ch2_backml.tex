...
\begin{figure}
  \centering
  \subfloat[$C=10000$]{\includegraphics[scale=0.65]{backml/svm_c10000.pdf}}
  \subfloat[$C=25$. Notice the new points \\ of class $1$ in the class $0$ cluster.]{\includegraphics[scale=0.65]{backml/svm_c25.pdf}}
...
\begin{figure}
  \centering
  \subfloat[Fully-developped]{\includegraphics[scale=0.65]{backml/dt_full.pdf}}
  \subfloat[Maximum depth of 3]{\includegraphics[scale=0.65]{backml/dt_max_depth3.pdf}}
