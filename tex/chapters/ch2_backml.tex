...
is the error of $h_B$ and is therefore irreductible. The \text{bias} is the error of the average model (over models generated from $LS$) with respect to $h_B$.
...
\begin{figure}
  ...
  \subfloat[Maximum depth = 3]{\includegraphics[scale=0.65]{backml/dt_max_depth3.pdf}}
