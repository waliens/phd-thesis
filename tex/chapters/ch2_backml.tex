...
\end{equation}
When working with image segmentation, $\mathcal{A}$ and $\mathcal{B}$ becomes the sets of true and predicted binary labels for the pixels in the image and the intersection falls back to a dot product. The resulting formula is:
\begin{equation}
...
% bias and variance over complexity
