...
During the course of the PhD, I have contributed to the development of Biaflows (\url{biaflows-doc.neubias.org}), an extended version of Cytomine designed for standardized benchmarking of bioimage analysis workflows. This work is not presented in the thesis but resulted in the following publication: 
\begin{itemize}
...
\begin{itemize}
  ...
  \item Chapter \ref{chap:strain}: \TODO{self-training repo} (code)
