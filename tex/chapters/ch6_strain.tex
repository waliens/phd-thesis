...
The Thyroid \acrshort{fnab} dataset introduced in Section \ref{ssec:strain:thyroid_data} offers a great opportunity to test our method on a real case of sparsely labeled data. It is interesting to note that this dataset is larger than the three public datasets used in this study (almost 5k images in total).
