...
\begin{figure}
  ...
  \subfloat[\label{fig:backdp:artifacts:autolysis1}]{\includegraphics[height=125pt]{backdp/JOMFP-22-279a-g007.jpg}}%
  \subfloat[\label{fig:backdp:artifacts:autolysis2}]{\includegraphics[height=125pt]{backdp/JOMFP-22-279a-g008.jpg}}%
  \subfloat[\label{fig:backdp:artifacts:microtomy1}]{\includegraphics[height=125pt]{backdp/artifact_dull_blade.png}}\\

  \subfloat[\label{fig:backdp:artifacts:microtomy2}]{\includegraphics[height=125pt]{backdp/calcification.png}}%
  \subfloat[\label{fig:backdp:artifacts:folding}]{\includegraphics[height=125pt]{backdp/folding_artifact.png}}%
  \subfloat[\label{fig:backdp:artifacts:staining}]{\includegraphics[height=125pt]{backdp/staining_artifact.png}}\\

  \subfloat[\label{fig:backdp:artifacts:scanning1}]{\includegraphics[height=125pt]{backdp/artifact_scanner_stitching.png}}%
  \subfloat[\label{fig:backdp:artifacts:scanning2}]{\includegraphics[height=125pt]{backdp/scanning_artifact.png}}%
...
\begin{figure}
  \centering
  \includegraphics[scale=0.1]{backdp/microtome.jpg}
  \caption{A microtome}
...
\begin{figure}
  \centering
  \subfloat{\includegraphics[width=420pt]{backdp/camelyon_lymphnode.png}} \\
  \subfloat{\includegraphics[height=150pt]{backdp/camelyon_metastase_noannot.png}}
  \hspace{0.5cm}
  \subfloat{\includegraphics[height=150pt]{backdp/camelyon_metastase_withannot.png}}
...
\begin{figure}
  \centering
  \subfloat{\includegraphics[height=80pt]{backdp/incl1.png}}
  \hspace{0.2cm}
  \subfloat{\includegraphics[height=80pt]{backdp/incl2.png}}
  \hspace{0.2cm}
  \subfloat{\includegraphics[height=80pt]{backdp/incl3.png}}
  \hspace{0.2cm}
  \subfloat{\includegraphics[height=80pt]{backdp/incl4.png}}
