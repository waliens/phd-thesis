...
Although there might be an optimal feature subset for other classifiers than \acrshort{et}, the fact that we observe a drop of performance when using the best features subset with \acrshort{svm} also suggests that we cannot draw this conclusion from our experiments and additional experiments would need to be carried out by applying \acrshort{rfe} to those classifiers as well.
