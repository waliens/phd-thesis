...
\includegraphics[width=\linewidth]{images/cytomine.png}
\end{frame}
...
\framesubtitle{Self-training at fixed $n_l$ - MoNuSeg}
	...
	\begin{itemize}
		...
		\item For MoNuSeg, the upper baseline is reached with only $\sim 30\%$ of the original annotations.
	\end{itemize}
	\vfill
	\begin{figure}
		...
		\begin{subfigure}{0.16\linewidth}
			\centering
			\raisebox{2cm}{\includegraphics[width=\textwidth]{images/legende.pdf}}
		\end{subfigure}
	\end{figure}
\end{frame}
...
\begin{frame}{Results}
\framesubtitle{Application to Thyroid FNAB - quantitative}
...
\begin{frame}{Results}
	\framesubtitle{Application to Thyroid FNAB - qualitative}
...
\begin{frame}{Future perspectives}
	...
	\begin{itemize}
		...
		\item Systematic review and benchmarking of representation learning in pathology
		...
		\item Integration of our algorithms for actual applications:
	\end{itemize}
	\begin{figure}
		\includegraphics[width=\linewidth]{images/pipeline.pdf}		
		\caption*{\tiny Segment with self-training - classify with a multi-task pre-trained model.}
	\end{figure}
	\vfill
\end{frame}
...
\section{Thank you}
{
\usebackgroundtemplate{\includegraphics[height=\paperheight]{images/th-1024x0-illus_thesis_rmormont.png}}
\begin{frame}
	\vfill
	\begin{center}
	{\Large \bf Thank you !}
