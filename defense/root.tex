...
\begin{frame}{Contributions}
	All contributions address digital pathology:
	\begin{itemize}
...
\begin{frame}{Pre-training the model in multi-task}
	Hyperparameters: 
	\begin{itemize}
		\item choice of backbone $\theta_s$ architecture: ResNet50, DenseNet121
		\item learning rate $\gamma$
		\item head learning rate multiplier $\tau_\gamma$
	\end{itemize}

	\textbf{Batch sampling}: a single batch contains samples from different tasks.     

	{\color{red}TODO: illustrate batch sampling} 
\end{frame}
...
\begin{frame}{Results}
	...
	This experiment confirms previously published results including ours:
	\begin{itemize}
...
\begin{frame}{An imperfectly-annotated cytology dataset}
	\vfill
	\begin{center}
...
\begin{frame}{Hard and soft pseudo-labeling}
	TODO
\end{frame}
...
\framesubtitle{Label sparsely or exhaustively ?}
	\begin{itemize}
		...
		\item MoNuSeg: annotation budget better spent on sparse labeling and using self-training
