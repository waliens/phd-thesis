...
\begin{frame}{Using machine and deep learning}
	\begin{center}
	Machine learning methods are often preferred to classical computer vision methods for tackling computer-aided pathology tasks.
	\end{center}
	\vfill
	\begin{figure}
		\centering
...
\begin{frame}[t]{Data scarcity in digital pathology}
	...
	\begin{columns}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.8\textwidth]{images/illuimagenet.jpg}
		\end{figure}
		\column{.25\linewidth}
		{
			\tiny
			...
			\begin{itemize}
				...
				\item \textbf{Images}: $1.3$M (now $14$M)
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.8\textwidth]{images/lizard.png}
		\end{figure}
		\column{.25\linewidth}
		{%
			\tiny%
...
\end{columns}
\vfill
\textbf{Option 2}: use appropriate computational methods. In this thesis:
\begin{columns}
	...
	\begin{column}[t]{0.49\linewidth}
		\begin{figure}
			\includegraphics[width=\textwidth]{images/selftraining.png}
...
\textbf{Goal}: devise \textbf{guidelines and best practices} for deep transfer learning with \textbf{ImageNet as a source task}
...
%       Inner IncV3		& {\color{grey}0.9836}	& {\color{grey}0.8899}	& {\color{grey}0.9951}	& {\color{grey}0.9964}	& {\color{grey}0.9731}	& {\color{grey}0.8104}	& {\color{grey}0.9201}	& {\color{grey}0.7507} \\
		\hdashline
 {\color{red}\textbf{Fine-tuning}}		& \textbf{0.9926}	& {\color{grey}0.8797}	& \textbf{0.9977}	& {\color{grey}0.9970}	& \textbf{0.9873}	& \textbf{0.8727}	& \textbf{0.9405}	& \textbf{0.8641} \\
%%      \hline
...
\begin{frame}{Using a pathology problem as a source task ?}
	\vfill
	\begin{center}
	Transfer from ImageNet works well !
	\end{center}
	\vfill 
	\begin{center}
		... but \textbf{transfer learning has been show to work better when target and source tasks are close} !
	\end{center}
	\vfill
	No ImageNet-like dataset in pathology so how can we pre-train a model ? 
	\vfill
	\begin{center}
	\Large We propose \textbf{multi-task pre-training} with many samll datasets rather than a large one. 
	\end{center}
\end{frame}
...
\begin{frame}{Several source tasks}
    ...
    \begin{tabular}{|r|c|c|l|c|c|c|c|}
        ...
        \hline
 				& MITOS-ATYPIA 14 & DET & & breast cancer & H\&E & 64873 & 3 \\
 				& Warwick CRC & DET & & colorectal cancer & H\&E & 2500 & 2 \\
 				& Janowczyk1 & SEG & & breast cancer & H\&E & 31725 & 2 \\
 				& Janowczyk2 & SEG & & breast cancer & H\&E & 3402 & 2 \\
 				& Janowczyk5 & DET & &  breast cancer & H\&E & 24870 & 2 \\
 				& Janowczyk6 & CLF & & breast, invasive ductal carci. & H\&E & 277524 & 2 \\
 				& Janowczyk7 & CLF & & breast, lymphoma & H\&E & 2244 & 3 \\
 				& Stroma LBP & CLF & & colorectal cancer & IHC & 2313 & 2 \\
 				& TUPAC2016 Mitosis & DET & & breast cancer & H\&E & 77853 & 2 \\
 				& BACH18 Micro & CLF & & breast cancer & H\&E & 4800 & 4 \\ 
 				& Camelyon16 & SEG & & breast cancer & H\&E & 2922216 & 2 \\
 				& UMCM Colorectal & CLF & & colorectal cancer & H\&E& 5000 & 8 \\
 				& Necrosis & CLF & & breast cancer & IHC & 882 & 2 \\
 				& ProliferativePattern & CLF & & thyroid cancer & Diff-Quik & 1857 & 2 \\
 				& CellInclusion & CLF & & thyroid cancer & Diff-Quik & 3637 & 2 \\
 				& MouseLba & DET & & lung cancer & MGG & 4284 & 8 \\
 				& HumanLba & DET & & lung cancer & MGG & 5420 & 9 \\
 				& Lung & CLF & & lung & H\&E & 6331 & 10 \\
 				& Breast1 & CLF & & breast cancer & H\&E & 23032 & 2 \\
 				& Breast2 & CLF & & breast cancer & H\&E & 17523 & 2 \\
 				& Glomeruli & CLF & & kidney & M3C & 29213 & 2 \\
 				& Bone marrow & CLF & & bone marrow & H\&E & 1291 & 9 \\
        \hline 
...
\begin{frame}{Results}
	...
	This experiment also confirms previously published results including ours:
	\begin{itemize}
...
\begin{frame}{Using sparsely-labeled data ?}
	...
	\begin{figure}
		\centering
		\includegraphics[height=0.2\textheight]{images/unet.png}
	\end{figure}
	\begin{flushright}
		\parencite{ronneberger2015unet}
	\end{flushright}
	\vfill
	\begin{center}
		We propose to use \textbf{self-training} $\Rightarrow$ use the segmentation model being train to generate the missing information.
	\end{center}
	\vfill
\end{frame}
...
\begin{frame}{Pseudo-labels and weighting startegies}
	...
	\end{itemize}
	\vfill 
	We \textbf{weight the pixel contribution} in the loss:
	\[
...
\framesubtitle{Self-training at fixed $n_l$ - MoNuSeg}
	...
	\begin{figure}
		\begin{subfigure}{\linewidth}
			\centering
			\includegraphics[width=\textwidth]{images/monusef_test_pxl_self_hard_dice_rho_entropy.pdf}
			\caption{MoNuSeg}
		\end{subfigure}
		\begin{subfigure}{\linewidth}
			\centering
			\includegraphics[width=\textwidth]{images/segpc_test_pxl_self_hard_dice_rho_entropy.pdf}
			\caption{SegPC}
		\end{subfigure}
		\begin{subfigure}{\linewidth}
			\centering
			\includegraphics[width=\textwidth]{images/glas_test_pxl_self_hard_dice_rho_entropy.pdf}
			\caption{GlaS}
		\end{subfigure}
	\end{figure}
\end{frame}
